            ...
            <div class="wrapper">
                <div class="signup">
                    ...
                    <div class="content-form">
                        <div class="y-style">
                            <form action="../facultyphp/resetpasswordauth.php" method="post">
                                ...
                                <p>
                                    ...
                                    <input type="text" placeholder="Enter your email" id="forpassEmail" name="email" autocomplete="off" onkeyup="validateInput()" autofocus>
                                    <small class="validation"></small>
                                </p>
                                <p>
                                    <label for="forpassPass">New Password <span>*</span></label>
                                    <input type="password" placeholder="Enter password" id="forpassPass" name="newpass" autocomplete="off" onkeyup="validateInput()">
                                    <small class="validation"></small>
                                </p>
                                <p>
                                    <label for="forpassCPass">Confirm Password <span>*</span></label>
                                    <input type="password" placeholder="Enter same password again" id="forpassCPass" name="cpass" autocomplete="off" onkeyup="validateInput()">
                                    <small class="validation"></small>
                                </p>
                                <p><button type="submit">Rest Password</button></p>
                            </form>
                            <div class="afterform">
                                <p>&lt;&lt;<a href="facultylogin.php" class="t-signup"> Back to Login</a></p>
                            </div>
                        </div>
                    </div>
                </div>
