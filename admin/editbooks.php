        ...
        <div id="page-content-wrapper">
            ...
            <div class="row">
                <div class="mx-auto col-10 col-md-8 col-lg-6 mb-5">
                    <form action="../adminphp/updatebook.php" method="post" enctype="multipart/form-data" class="shadow bg-light p-4 rounded mt-3" style="width: 90%; max-width: 50rem;">
                        ...
                        <div class="form-group mt-5 modal-footer justify-content-center">
                            <table>
                                <tr>
                                    ...
                                    <td class="ps-5"><a href="admindashboard.php" class="btn btn-outline-dark shadow-none">Back to Dashboard</a></td>
                                </tr>
                            </table>
                        </div>
                    </form>
