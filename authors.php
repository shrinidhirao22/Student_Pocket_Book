...
if(isset($_SESSION['user_id']) && isset($_SESSION['user_email']))
{
    ...
    $books=get_books_by_AuthorID($conn,$id);
    $current_author=get_current_Author($conn,$id);
...
<head>
    ...
    <title>Course: <?=$current_author['author_name']?></title>
    <!-- bootstrap 5 CDN-->
...
<body>
    ...
    <section class="m-5">
        ...
        <div class="mt-5 mb-5">
            ...
            <p style="color:black; text-align: center;font-size:14px;line-height: 1.5;" class="fw-bold">Download Books related to course <?=$current_author['author_name']?> of all Semesters</p>
        </div>
